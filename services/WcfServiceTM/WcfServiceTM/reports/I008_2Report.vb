...
EXIT_SUB:
    ...
    Private Sub GroupFooter1_ControlAdded(sender As Object, e As ARControlEventArgs) Handles GroupFooter1.ControlAdded

    End Sub

    Private Sub GroupHeader2_Format(sender As Object, e As EventArgs) Handles GroupHeader2.Format
