...
Public Class Cns_Com
    ...
    Public Shared C_NUMBER1 As String = "①"
    Public Shared C_NUMBER2 As String = "②"
    Public Shared C_NUMBER3 As String = "③"
    Public Shared C_NUMBER4 As String = "④"
    Public Shared C_NUMBER5 As String = "⑤"
    Public Shared C_NUMBER6 As String = "⑥"
    Public Shared C_NUMBER7 As String = "⑦"
    Public Shared C_NUMBER8 As String = "⑧"
    Public Shared C_NUMBER9 As String = "⑨"
    Public Shared C_NUMBER10 As String = "⑩"
    Public Shared C_NUMBER11 As String = "⑪"
    Public Shared C_NUMBER12 As String = "⑫"
    Public Shared C_NUMBER13 As String = "⑬"
    Public Shared C_NUMBER14 As String = "⑭"
    Public Shared C_NUMBER15 As String = "⑮"
    Public Shared C_NUMBER16 As String = "⑯"
    Public Shared C_NUMBER17 As String = "⑰"
    Public Shared C_NUMBER18 As String = "⑱"
    Public Shared C_NUMBER19 As String = "⑲"
    Public Shared C_NUMBER20 As String = "⑳"
    '
    Public Shared C_MONTH1 As String = "１月"
    Public Shared C_MONTH2 As String = "２月"
    Public Shared C_MONTH3 As String = "３月"
    Public Shared C_MONTH4 As String = "４月"
    Public Shared C_MONTH5 As String = "５月"
    Public Shared C_MONTH6 As String = "６月"
    Public Shared C_MONTH7 As String = "７月"
    Public Shared C_MONTH8 As String = "８月"
    Public Shared C_MONTH9 As String = "９月"
    Public Shared C_MONTH10 As String = "１０月"
    Public Shared C_MONTH11 As String = "１１月"
    Public Shared C_MONTH12 As String = "１２月"
